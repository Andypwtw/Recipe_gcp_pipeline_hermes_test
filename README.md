...
## 2026-09-21 熱量 / 價格規則更新

本版本已套用新的主要食材 20% 缺值判斷、>500 kcal 例外、辛香佐料 80g、普通調味料 50g、高熱量調味料 20g 規則。

價格改為逐食材顯示：有資料顯示 `$整數`，無資料顯示 `$無資料`；每個單項價格先無條件進位，再加總成食譜總金額。完整規則見 `docs/CALCULATION_POLICY_20260921.md`。
